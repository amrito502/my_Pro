...
class SellerProductController extends Controller
{
    public function index()
    {
        ...
        return view('seller.components.product.index', compact('products'));
    }


    public function getsellerSubDistricts(Request $request)
    {
        $subDistricts = SubDistrict::where('district_id', $request->district_id)->get();
        return response()->json($subDistricts);
    }

    public function getsellerSubCategories(Request $request)
    {
    ...
    public function create()
    {
        ...
        return view('seller.components.product.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('sellerproducts.index')->with('success', 'Product created successfully.');
    }
    ...
    public function seller_product_show($id)
    {
        ...
        return view('seller.components.product.show',compact('product'));
    }
    ...
    public function seller_product_edit($id)
    {
        ...
        $brands = Brand::all();
        return view('seller.components.product.edit', compact('subDistricts','subCategories','product', 'districts', 'sections', 'categories', 'brands'));
    }
    ...
    public function seller_product_update(Request $request, $id)
    {
        ...
        return redirect()->route('sellerproducts.index')->with('success', 'Product updated successfully.');
    }
    ...
    public function seller_product_delete($id)
    {
        ...
        $product->delete();
        return redirect()->route('sellerproducts.index')->with('success', 'Product deleted successfully.');
    }
}
