    ...
    <div class="sa-toolbar__body">
        ...
        <div class="sa-toolbar__item dropdown">
            <button
                ...
                aria-expanded="false"
            >
                <img src="{{ url('') }}/vendor/flag-icons/24/DE.png" class="sa-language-icon" alt="" />
            </button>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton3">
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        <img src="{{ url('') }}/vendor/flag-icons/24/DE.png" class="sa-language-icon me-3" alt="" />
                        <span class="ps-2">German</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        <img src="{{ url('') }}/vendor/flag-icons/24/FR.png" class="sa-language-icon me-3" alt="" />
                        <span class="ps-2">French</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        <img src="{{ url('') }}/vendor/flag-icons/24/GB.png" class="sa-language-icon me-3" alt="" />
                        <span class="ps-2">English</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        <img src="{{ url('') }}/vendor/flag-icons/24/RU.png" class="sa-language-icon me-3" alt="" />
                        <span class="ps-2">Russian</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        <img src="{{ url('') }}/vendor/flag-icons/24/IT.png" class="sa-language-icon me-3" alt="" />
        ...
        <div class="dropdown sa-toolbar__item">
            ...
            >
                <span class="sa-toolbar-user__avatar sa-symbol sa-symbol--shape--rounded">
                    @if (!auth()->user()->image)
                    <img src="{{ url('') }}/images/customers/customer-4-64x64.jpg" width="64" height="64" alt="" />
                    @else
                    <img src="{{ asset('uploads/profile/'.auth()->user()->image) }}" width="64" height="64" alt="" />
                    @endif
            ...
            <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton">
                <li><a class="dropdown-item" href="{{ route('seller_update_profile_page') }}">Profile</a></li>
