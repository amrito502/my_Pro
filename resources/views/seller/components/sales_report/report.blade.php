...
<div class="row">
    <h2 class="mb-4 mt-4">Sales Reports</h2>
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="text-center" style="font-size: 23px;background: #f1efef;padding: 20px;color: #ff7600;font-weight: 800;">Total Earning : <i class="fa-solid fa-bangladeshi-taka-sign"></i>  {{ $total_earnings }}</h3>
            </div>
            <div class="p-4">
                ...
                <tbody>
                    @foreach ($orders as $key=>$order)
                        <tr>
                            ...
                            <td><a href="" class="text-reset">{{ $order->order->transaction->status }}</a></td>
                            <td>
