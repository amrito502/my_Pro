                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="d-flex justify-content-between mt-3">
                                <a class="btn btn-sm btn-outline-primary" href="{{ route('seller_product.edit', $product->id) }}">Edit</a>
                                <a class="btn btn-sm btn-danger" href="{{ route('seller_product.delete', $product->id) }}">Delete</a>

                                {{-- <form action="{{ route('sellerproducts.destroy', $product->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                    @csrf
                                    @method('DELETE')
